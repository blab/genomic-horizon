...
\begin{figure}[h]
 \centering
  \subfloat{
  \includegraphics[width=0.65\textwidth]{supp_figures/sfigX_genome_mcmc.png}
  }\\
  \subfloat{
  \includegraphics[width=0.65\textwidth]{supp_figures/sfigX_gp_mcmc.png}
  }
  \\
